...
export const Payments = () => {
    ...
    if (isPaidPlan) {
        return (
            <div className="min-h-screen bg-[radial-gradient(circle_at_top,#eff6ff,#e0e7ff_35%,#f8fafc_70%)] px-4 py-6 sm:py-10">
                <div className="mx-auto flex min-h-[80vh] max-w-3xl items-center justify-center">
                    <div className="w-full rounded-[28px] border border-emerald-200/70 bg-white/90 p-7 sm:p-8 shadow-[0_24px_80px_-36px_rgba(16,185,129,0.45)] backdrop-blur">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">Your account is already upgraded.</h1>
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <Button onClick={() => navigate('/home')} className="w-full gap-2 rounded-full px-6 sm:w-auto sm:justify-center">
                                Go to home
    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_top,#eff6ff,#dbeafe_28%,#f8fafc_68%)] px-4 py-6 sm:py-10">
            <div className="mx-auto grid min-h-[80vh] max-w-5xl items-center gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                <section className="rounded-[32px] border border-white/70 bg-slate-950 px-6 py-8 sm:px-8 sm:py-10 text-white shadow-[0_30px_80px_-40px_rgba(15,23,42,0.85)]">
                    ...
                    <h1 className="mt-6 text-3xl sm:text-4xl font-semibold leading-tight tracking-tight">Switch to Paid and remove the limits.</h1>
                ...
                <section className="rounded-[32px] border border-slate-200/80 bg-white/90 p-6 sm:p-8 shadow-[0_24px_80px_-36px_rgba(15,23,42,0.28)] backdrop-blur">
